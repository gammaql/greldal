      ...
      if (activeCategory && rootEntityName) {
        ...
        try {
          for (var _iterator = this.state.hierarchy[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            rootEntity = rootEntity || Object(_utils_api__WEBPACK_IMPORTED_MODULE_11__["findInHierarchy"])(category, namePath);
          }
        } catch (err) {
...
//# sourceMappingURL=api.js.72fe1e1fe6be2220742a.hot-update.js.map