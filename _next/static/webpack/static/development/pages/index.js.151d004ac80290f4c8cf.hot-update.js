...
})(["padding-top:20px;@media only screen and (min-width:1000px){padding-left:10px;}@media only screen and (max-width:500px){font-size:1rem;}"]);
...
})(["display:inline;@media only screen and (max-width:1000px){display:block;text-align:center;line-height:2.5rem;}"]);
...
//# sourceMappingURL=index.js.151d004ac80290f4c8cf.hot-update.js.map