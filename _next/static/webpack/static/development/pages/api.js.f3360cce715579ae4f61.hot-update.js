      ...
      if (active && active.rootEntityName) {
        ...
        try {
          for (var _iterator = this.state.hierarchy[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var h = _step.value;
            rootEntity = Object(_utils_api__WEBPACK_IMPORTED_MODULE_11__["findInHierarchy"])(h, active.rootEntityName.split("."));
...
//# sourceMappingURL=api.js.f3360cce715579ae4f61.hot-update.js.map