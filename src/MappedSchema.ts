 ...
 */
export function mapSchema(operations: MappedSingleSourceOperation<any, any>[]) {
...
function deriveGraphQLObjectType(
    name: string,
    operations: MappedSingleSourceOperation<any, any>[],
): Maybe<GraphQLObjectType> {
    return isEmpty(operations)
        ? undefined
        : new GraphQLObjectType({
              name,
              fields: transform<MappedSingleSourceOperation<any, any>, GraphQLFieldConfig<any, any>>(
                  operations,
